        ...
        try {
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `DOWNLOADED BY ALASTOR-XMD\n\n📝 Title: ${title}` : "DOWNLOADED BY ALASTOR-XMD";
                    ...
                    try {
                        const caption = title ? `𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 𝐀𝐋𝐀𝐒𝐓𝐎𝐑-𝐗𝐌𝐃\n\n📝 Title: ${title}` : "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 𝐀𝐋𝐀𝐒𝐓𝐎𝐑-𝐗𝐌𝐃";
