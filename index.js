...
let owner = JSON.parse(fs.readFileSync('./data/darkempiretech.json'))

global.botname = "ALASTOR-XD"
global.themeemoji = "•"
    ...
    try {
        ...
        if (!fs.existsSync(autojoinPath)) {
            const defaultConfig = {
                ...
                welcomeMessage: "╭━━━━━━━━━━━━━━━━━━┈⊷\n┃✮│➣ *🤖 WELCOME TO ALASTOR-XD*\n╰━━━━━━━━━━━━━━━━━━┈⊷\n\n✅ *Auto-joined to our community!*\n\n📢 *Channel:* ALASTOR-XD Updates\n👥 *Support:* Contact owner\n\nUse .alastor for commands menu!"
            };
        ...
        if (connection == "open") {
            ...
            try {
                ...
                await XeonBotInc.sendMessage(botNumber, {
                    text: `╭━━━━━━━━━━━━━━━━━━┈⊷\n┃✮│➣ *🤖 ALASTOR-XD CONNECTED*\n╰━━━━━━━━━━━━━━━━━━┈⊷\n\n✅ *Connected Successfully!*\n\n⏰ *Time:* ${new Date().toLocaleString()}\n📊 *Status:* Online and Ready!\n\n*Use .alastor for commands alastor*`,
                    contextInfo: {
                        forwardingScore: 1,
                        isForwarded: true,
                        forwardedNewsletterMessageInfo: {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'ALASTOR-XD'} ]`)}\n\n`))
